@php
    $poster_logo_details = unserialize($poster->logo_details); 
    $poster_phone_details = unserialize($poster->phone_details);
    $poster_email_details = unserialize($poster->email_details);
    $poster_company_details = unserialize($poster->company_details);
    $poster_address_details = unserialize($poster->address_details);   
...
<x-Header name='Edit Poster' /> 
                ...
                <section class="formone">
                    ...
                    <form id="poster-form" method="post" action="{{ route('poster.update', $poster->id) }}"
                        ...
                        <div class="py-3 px-3">
                            ...
                            <input type="range" class="w-[60%]" id="logo_x_pos" value="{{ $logo_x_pos }}"
                                name="logo_x_pos"><br>
                            <label for="logo_y_pos">Y Position Range:</label>
                            <input type="range" class="w-[60%]" id="logo_y_pos" value="{{ $logo_y_pos }}"
                                name="logo_y_pos"><br>
                            <label for="logo_width">Width:</label>
                            <input type="range" class="w-[60%]" id="logo_width" value="{{ $logo_width }}"
                                name="logo_width">
                        </div>
                        ...
                        <div class="py-6 px-3">
                            ...
                            <select name="address_font_family" id="address_font_family"
                                class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" value="{{ $address_font_family }}">
                                @foreach ($ttf as $font)                                
                                    <option value="{{ $font }}">{{ $font }}</option>
                                @endforeach
                            </select>
    ...
    {{-- script src using assets variable laravel --}}
