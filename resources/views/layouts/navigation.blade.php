...
<hr
    class="h-px mt-5 bg-transparent bg-gradient-to-r from-transparent via-black/40 to-transparent dark:bg-gradient-to-r dark:from-transparent dark:via-white dark:to-transparent" />
    ...
    <ul class="flex flex-col pl-0 mb-0">
        ...
        <li class="mt-0.5 w-full">
            <a href="{{ route('dashboard') }}"
                class="@php echo  request()->routeIs('dashboard') ? "py-[5px] bg-blue-500/13": ""; @endphp dark:text-white dark:opacity-80 py-[5px] text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
                href="#">
                <div
        ...
        <li class="mt-0.5 w-full">
            ...
            <a class="dark:text-white dark:opacity-80 py-[5px] text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors flex-start"
                ...
                <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Company</span>
            ...
            <ul id="dropdown-example" class="hidden py-2 space-y-2">
                ...
                <li>
                    <a href="{{ route('company.add') }}"
                        class="mx-5 py-[5px] @php echo  request()->routeIs('company.add') ? "py-[5px] bg-blue-500/13": ""; @endphp dark:text-white dark:opacity-80 text-sm ease-nav-brand my-0 flex items-center whitespace-nowrap px-4 transition-colors flex-start"
                        href="#">
                        <div
                            class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center fill-current stroke-0 text-center xl:p-2.5">
                            <i class="relative top-0 leading-normal text-cyan-500 text-sm ni ni-app"></i>
                ...
                <li>
                    <a href="{{ route('company.list') }}"
                        class="mx-5 @php echo  request()->routeIs('company.list') ? "py-[5px]  bg-blue-500/13": ""; @endphp dark:text-white dark:opacity-80 py-[5px] text-sm ease-nav-brand my-0 flex items-center whitespace-nowrap px-4 transition-colors flex-start"
                        href="#">
                        <div
                            class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                            <i class="relative top-0 leading-normal text-cyan-500 text-sm ni ni-app"></i>
        ...
        <li class="mt-0.5 w-full">
            ...
            <a class="dark:text-white dark:opacity-80 py-[5px] text-sm ease-nav-brand my-0 mx-2 items-center whitespace-nowrap px-4 transition-colors flex flex-start"
                aria-controls="dropdown-example1" data-collapse-toggle="dropdown-example1">
                <div
                    class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center fill-current stroke-0 text-center xl:p-2.5">
                    <i class="relative top-0 text-sm leading-normal text-orange-500 ni ni-calendar-grid-58"></i>
                </div>
                <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Poster</span>
                <div class="flex">
                    <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
            ...
            <ul id="dropdown-example1" class="hidden py-2 space-y-2">
                ...
                <li>
                    <a href="{{ route('poster.add') }}"
                        ...
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Poster Add</span>
        ...
        @if (Auth::user()->is_admin == 1)
            <li class="mt-0.5 w-full">
                <a href="{{ route('users.List') }}"
                    class="@php echo  request()->routeIs('users.List') ? "py-[5px] bg-blue-500/13": ""; @endphp  dark:text-white dark:opacity-80 py-[5px] text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors flex-start"
                    href="#">
                    <div
                        class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
